...
const EXPLORER_PREFIXES: { [chainId: number]: string } = {
  ...
  // TODO: add more
  [SupportedChainId.FUSE_MAINNET]: 'https://explorer.fuse.io',
  [SupportedChainId.BSC_MAINNET]: 'https://bscscan.com',
  [SupportedChainId.METIS_ANDROMEDA]: 'https://andromeda-explorer.metis.io',
  [SupportedChainId.MAINNET]: 'https://etherscan.io',
  [SupportedChainId.XDC_APOTHEM]: 'https://explorer.apothem.network',
}
...
export function getExplorerLink(chainId: number, data: string, type: ExplorerDataType): string {
  ...
  const prefix = EXPLORER_PREFIXES[chainId] ?? 'https://etherscan.io'
