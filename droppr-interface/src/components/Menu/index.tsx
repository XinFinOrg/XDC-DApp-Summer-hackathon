...
import { Check, ChevronLeft, Coffee, GitHub, HelpCircle, Info, MessageCircle, Moon, Sun } from 'react-feather'
          ...
          (() => {
            switch (menu) {
              ...
              default:
                return (
                  <MenuFlyout>
                    <MenuItem href="https://droppr.one">
                      <div>
                        <Trans>About</Trans>
                      </div>
                      <Info opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href="mailto: help@droppr.one">
                      <div>
                        <Trans>Help Center</Trans>
                      </div>
                      <HelpCircle opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href="mailto: hello@droppr.one">
                      <div>
                        <Trans>Request Features</Trans>
                      </div>
                      <Coffee opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href="https://t.me/dropprone">
                      <div>
                        <Trans>Telegram</Trans>
                      </div>
                      <MessageCircle opacity={0.6} size={16} />
                    </MenuItem>
                    <MenuItem href="https://github.com/dropprone">
                      <div>
                        <Trans>Github</Trans>
                      </div>
