      ...
      {open && (
        <FlyoutMenu>
          <FlyoutMenuContents>
            ...
            <Row onSelectChain={handleChainSwitch} targetChain={SupportedChainId.FUSE_MAINNET} />
            <Row onSelectChain={handleChainSwitch} targetChain={SupportedChainId.MAINNET} />
            <Row onSelectChain={handleChainSwitch} targetChain={SupportedChainId.METIS_ANDROMEDA} />
            <Row onSelectChain={handleChainSwitch} targetChain={SupportedChainId.XDC_APOTHEM} />
          </FlyoutMenuContents>
        </FlyoutMenu>
      )}
    </SelectorWrapper>
