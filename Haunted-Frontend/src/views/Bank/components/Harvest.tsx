...
const Harvest: React.FC<HarvestProps> = ({ bank }) => {
  ...
  const hShareStats = useShareStats();

  const tokenName = bank.earnTokenName === 'HSHARE' ? 'HSHARE' : 'HAUNTED';
  const tokenStats = bank.earnTokenName === 'HSHARE' ? hShareStats : hauntedStats;
