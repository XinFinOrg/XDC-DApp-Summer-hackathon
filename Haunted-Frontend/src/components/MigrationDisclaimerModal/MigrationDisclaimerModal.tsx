...
const MigrationDisclaimerModal: React.FC<MigrationDisclaimerModalProps> = ({ onConfirm, onDismiss }) => {
  ...
  return (
    <Modal>
      ...
      <div>
        <StyledText>
          Due to the upgrade, all Staking functionalities other than [Settle and withdraw] has been disabled for users
          who staked in legacy Staking. Please withdraw all balances from the previous staking after the update.
        </StyledText>
      </div>
      <ModalActions>
