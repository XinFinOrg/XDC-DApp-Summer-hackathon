...
/**
 * ACADP_Widget_Carousel_Slider Class.
 *
 * @since 1.6.4
 */
class ACADP_Widget_Carousel_Slider extends WP_Widget {
	...
	public function __construct() {	
		parent::__construct(
			'acadp-slider-carousel-slider',
			__( 'ACADP - Carousel Slider', 'advanced-classifieds-and-directory-pro' ),
			array(
				'classname'   => 'acadp-slider-carousel-slider-class',
				'description' => __( 'Carousel Slider for Advanced Classifieds and Directory Pro', 'advanced-classifieds-and-directory-pro' )
			)
		);		
	}
	...
	public function widget( $args, $instance ) {
		// WP Query
		$atts = acadp_premium_slider_atts( $instance, 'carousel_slider' );		
	...
	public function update( $new_instance, $old_instance ) {
		...
		$instance['slides_to_show']       = isset( $new_instance['slides_to_show'] ) ? (int) $new_instance['slides_to_show'] : 1;
		$instance['slides_to_scroll']     = isset( $new_instance['slides_to_scroll'] ) ? (int) $new_instance['slides_to_scroll'] : 1;
		$instance['images_size']          = isset( $new_instance['images_size'] ) ? sanitize_text_field( $new_instance['images_size'] ) : 'full';
		...
		$instance['center_mode']          = isset( $new_instance['center_mode'] ) ? (int) $new_instance['center_mode'] : 0;
	...
	public function form( $instance ) {
		$instance = acadp_premium_slider_atts( $instance, 'carousel_slider', 1 );
		
		// Display the admin form
		include( ACADP_PLUGIN_DIR . 'premium/widgets/forms/carousel-slider.php' );
	}
