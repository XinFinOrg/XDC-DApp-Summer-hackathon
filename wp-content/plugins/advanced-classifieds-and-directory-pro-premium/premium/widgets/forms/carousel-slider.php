...
<p>
	<label for="<?php echo $this->get_field_id( 'slides_to_show' ); ?>"><?php _e( 'Slides to Show', 'advanced-classifieds-and-directory-pro' ); ?></label> 
    <select class="widefat" id="<?php echo $this->get_field_id( 'slides_to_show' ); ?>" name="<?php echo $this->get_field_name( 'slides_to_show' ); ?>"> 
		<?php
			for ( $i = 1; $i <= 10; $i++ ) {
				printf( '<option value="%s"%s>%s</option>', $i, selected( $i, $instance['slides_to_show'] ), $i );
			}
		?>
    </select>
</p>
...
<p>
	<label for="<?php echo $this->get_field_id( 'slides_to_scroll' ); ?>"><?php _e( 'Slides to Scroll', 'advanced-classifieds-and-directory-pro' ); ?></label> 
    <select class="widefat" id="<?php echo $this->get_field_id( 'slides_to_scroll' ); ?>" name="<?php echo $this->get_field_name( 'slides_to_scroll' ); ?>"> 
		<?php
			for ( $i = 1; $i <= 10; $i++ ) {
				printf( '<option value="%s"%s>%s</option>', $i, selected( $i, $instance['slides_to_scroll'] ), $i );
			}
		?>
    </select>
</p>
...
<p>
	<label for="<?php echo $this->get_field_id( 'images_size' ); ?>"><?php _e( 'Images Size', 'advanced-classifieds-and-directory-pro' ); ?></label>
    <select class="widefat" id="<?php echo $this->get_field_id( 'images_size' ); ?>" name="<?php echo $this->get_field_name( 'images_size' ); ?>"> 
		<?php
			$options = array(
			...
			foreach ( $options as $key => $value ) {
				printf( '<option value="%s"%s>%s</option>', $key, selected( $key, $instance['images_size'] ), $value );
			}
		?>
    </select>
</p>
...
<p>
	<label for="<?php echo $this->get_field_id( 'arrows_right_offset' ); ?>"><?php _e( 'Arrows Right Offset', 'acadp-slider' ); ?></label> 
...
<p>
	<input type="checkbox" value="1" <?php checked( $instance['center_mode'] ); ?> id="<?php echo $this->get_field_id( 'center_mode' ); ?>" name="<?php echo $this->get_field_name( 'center_mode' ); ?>" />
	<label for="<?php echo $this->get_field_id( 'center_mode' ); ?>"><?php _e( 'Center Mode', 'advanced-classifieds-and-directory-pro' ); ?></label>
</p>