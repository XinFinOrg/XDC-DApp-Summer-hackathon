...
/**Mel: 25/01/22
 * Generate a permalink for smart contract receipt page.
 *
 */
function acadp_get_create_contract_receipt_page_link( $contract_address, $contract_tx_hash, $wallet_address ) {
	$page_settings = get_option( 'acadp_page_settings' );
	...
	$link = add_query_arg( array( 'acadp_action' => 'contract', 'contract_address' => $contract_address, 'contract_tx_hash' => $contract_tx_hash, 'wallet_address' => $wallet_address ), $link );
