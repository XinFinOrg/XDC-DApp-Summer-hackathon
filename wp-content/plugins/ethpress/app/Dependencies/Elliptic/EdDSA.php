...
use losnappas\Ethpress\Dependencies\Elliptic\EdDSA\KeyPair;
use losnappas\Ethpress\Dependencies\Elliptic\EdDSA\Signature;
...
class EdDSA {
    ...
    function __construct($curve) {
        ...
        $curve = \losnappas\Ethpress\Dependencies\Elliptic\Curves::getCurve($curve)->curve;
        $this->curve = $curve;
        $this->g = $curve->g;
