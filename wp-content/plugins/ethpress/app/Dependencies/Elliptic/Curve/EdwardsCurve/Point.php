<?php
namespace losnappas\Ethpress\Dependencies\Elliptic\Curve\EdwardsCurve;

use losnappas\Ethpress\Dependencies\BN\BN;

class Point extends \losnappas\Ethpress\Dependencies\Elliptic\Curve\BaseCurve\Point
{
    public $x;
    public $y;
    public $z;
