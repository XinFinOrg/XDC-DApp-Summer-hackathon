...
namespace losnappas\Ethpress\Dependencies\Elliptic\Curve\ShortCurve;

use JsonSerializable;
use losnappas\Ethpress\Dependencies\BN\BN;

class Point extends \losnappas\Ethpress\Dependencies\Elliptic\Curve\BaseCurve\Point implements JsonSerializable
{
    public $x;
    public $y;
    public $inf;
