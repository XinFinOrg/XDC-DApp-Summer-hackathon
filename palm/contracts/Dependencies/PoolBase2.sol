...
/*
* Base contract for ActivePool and DefaultPool. Inherits from PalmCustomBase
* and contains additional array operation functions and _requireCallerIsPalmController()
*/
contract PoolBase2 is PalmCustomBase {
     ...
     *    always to the index in PalmController of that token. Time complexity depends
